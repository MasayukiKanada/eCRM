                            ...
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input disabled type="radio" v-model="form.status" id="status" name="status" :value="1">未キャンセル
                                        <input disabled type="radio" v-model="form.status" id="status" name="status" :value="0">キャンセルする
                                    </div>
                                    </div>
