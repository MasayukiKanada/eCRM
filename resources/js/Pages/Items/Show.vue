                        ...
                        <section class="text-gray-600 body-font relative">
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="p-2 w-full">
                                    <div class="relative">
                                        <label for="status" class="leading-7 text-sm text-gray-600">販売</label>
                                    ...
                                    <button @click="deleteItem(item.id)" class="flex mx-auto bg-red-500 text-white border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">削除する</button>
                                    </div>
                                </div>
                                </div>
                            </div>
